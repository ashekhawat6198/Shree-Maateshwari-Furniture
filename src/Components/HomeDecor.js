...
import { decorItems } from '../HomeDecorItem'
function HomeDecor() {
  return (
    <div className='w-screen mt-[3rem]'>
        <h1 className='mt-[2rem] text-[34px] ml-11 text-gray-700 font-medium'>Home Decor</h1>
        <p className='mt-[-3px] ml-11 text-[20px] text-gray-500'>Little Things Matter</p>
